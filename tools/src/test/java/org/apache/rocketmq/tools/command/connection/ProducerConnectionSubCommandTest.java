...
public class ProducerConnectionSubCommandTest {
    ...
    public void testExecute() throws SubCommandException {
        ...
        String namesrvAddrFromEnv = System.getenv(MixAll.NAMESRV_ADDR_ENV);
        String namesrvAddr = System.getProperty(MixAll.NAMESRV_ADDR_PROPERTY, namesrvAddrFromEnv);
        System.out.println("namesrvAddrFromEnv:" + namesrvAddrFromEnv);
        System.out.println("namesrvAddr:" + namesrvAddr);

        namesrvAddr = "192.168.199.171:9876";
...
//        String[] subargs = new String[] {"-g default-producer-group", "-t unit-test"};
        String[] subargs = new String[] {"-n 192.168.199.171:9876", "-g producerGroupName", "-t myTopicTest"};
